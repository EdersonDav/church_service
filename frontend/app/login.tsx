    ...
    <View className="flex-1 bg-background">
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: 'center', paddingHorizontal: 24 }}>
        ...
        <View className="mb-10 mt-8">
          <Text className="text-5xl font-extrabold text-white tracking-tight mb-2">
            The<Text className="text-primary">Church</Text>
          </Text>
        ...
        <View className="space-y-6">
          <View className="space-y-2">
            <Text className="text-textMuted font-semibold ml-1 text-sm uppercase tracking-wider">E-mail</Text>
            <TextInput
          ...
          <View className="space-y-2">
            <Text className="text-textMuted font-semibold ml-1 text-sm uppercase tracking-wider">Senha</Text>
            <TextInput
              className="w-full text-textBase bg-surface border border-surfaceAlt rounded-2xl px-5 py-4 text-base focus:border-primary"

...
let UserTask = class UserTask extends base_1.BaseEntity {
};
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => tasks_entity_1.Task, (task) => task.id, { onDelete: 'CASCADE' }),
    (0, typeorm_1.JoinColumn)({ name: 'task_id' }),
    __metadata("design:type", tasks_entity_1.Task)
], UserTask.prototype, "task", void 0);
exports.UserTask = UserTask = __decorate([
    (0, typeorm_1.Entity)(enums_1.EntityEnum.USER_TASK),
    (0, typeorm_1.Unique)('user_task_unique', ['user', 'task'])
], UserTask);

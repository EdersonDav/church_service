...
exports.ListExtraEventsByChurch = void 0;
const common_1 = require("@nestjs/common");
const interfaces_1 = require("../../../../database/repositories/interfaces");
let ListExtraEventsByChurch = class ListExtraEventsByChurch {
    constructor(extraEventRepository) {
        this.extraEventRepository = extraEventRepository;
    }
    async execute({ church_id }) {
        const data = await this.extraEventRepository.listByChurch(church_id);
        return { data };
    }
};
exports.ListExtraEventsByChurch = ListExtraEventsByChurch;
exports.ListExtraEventsByChurch = ListExtraEventsByChurch = __decorate([
